...
var va = (0, import_react.forwardRef)((a2, t2) => {
  const { children: n2, className: r2, colorScheme: l2, platform: _2 = q() ? "ios" : "android" } = a2, i2 = _e({ listenChanges: !l2 }), o2 = l2 ?? i2, s2 = (0, import_react.useMemo)(() => ({ colorScheme: o2, platform: _2 }), [o2, _2]), c2 = y(ma.MaxUI, ma[`MaxUI_colorScheme_${o2}`], ma[`MaxUI_platform_${_2}`], r2);
